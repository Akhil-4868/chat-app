...
const LoginPage = () => {
  ...
  const onSubmitHandler = (event) => {
    ...
    // Step 1 of signup → just move to bio step
    if (currState === "Sign Up" && !isDataSubmitted) {
      setIsDataSubmitted(true);
      return; // don't call login yet
    }

    // Final signup OR login
  ...
  return (
    ...
    >
      {/*----left----*/}
      <img
        src={assets.Quick_Chat_Logo_Big}
        alt=""
        className="w-[clamp(100px,12vw,200px)]"
      />
      ...
      >
        ...
        {/* Full name only for Sign Up (first step) */}
        ...
        {/* Bio only for Sign Up (second step) */}
        {currState === "Sign Up" && isDataSubmitted && (
          <textarea
